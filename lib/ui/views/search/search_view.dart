...
class _SearchViewState extends State<SearchView> {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, SortOption> mapSortOption = {
      'fit': SortOption(index: 0, route: getQuery(params: widget.params, sortField: "",  page: page)),
      'score': SortOption(index: 1, route: getQuery(params: widget.params, sortField: "score", page: page)),
      'updatedAt': SortOption(index: 2, route: getQuery(params: widget.params, sortField: "updatedAt", page: page)),
      'updatedAtASC': SortOption(index: 3, route: getQuery(params: widget.params, sortField: "updatedAt", sort: "ASC", page: page))
    };
    searchController.text = widget.params['searchContent'] ?? "";

    List<String> listSortOption = ["Phù hợp nhất", "Lượt vote giảm dần", "Mới nhất", "Cũ nhất"];
    String sortSelected;
    if(widget.params == null || !widget.params.containsKey('sortField') || widget.params['sortField'] == "")
      sortSelected = 'fit';
    else if(widget.params['sortField'] == "updatedAt" && widget.params['sort'] == "ASC")
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: FloatingActionButton(
                                      ...
                                      onPressed: () {
                                        appRouter.go(getSearchQuery(params: widget.params, searchStr: searchController.text, page: page));
                                      },
                              ...
                              StreamBuilder(
                                ...
                                builder: (context, snapshot) {
                                  if(!mapSortOption.containsKey(sortSelected))
                                    return Center(child: Text("Lỗi! Không thể sort theo ${widget.params['sortField']}", style: TextStyle(color: Colors.red),));
                                  if(snapshot.hasData) {
                                    ResultCount<PostAggregation> resultCount = snapshot.data;
                                    if(!resultCount.resultList.isEmpty)
                                      return Column( //build lai
                                        children: [
                                          Container(
                                                    ...
                                                    DropdownButtonHideUnderline(
                                                        child: DropdownButton<String>(
                                                          ...
                                                          onChanged: (String? newValue) {
                                                            ...
                                                            appRouter.go(mapSortOption[key]?.route ?? "/viewsearch/");
                                                          },
                                                          ...
                                                          focusColor: Color.fromRGBO(242, 238, 242, 1),
                                                        )
                                                    )
                                                  ],
                                                )
                                          ...
                                          Column(
                                            children: [
                                              ...
                                              Pagination(path: "/viewsearch", totalItem: resultCount.count, params: widget.params, selectedPage: page,)
                                            ],
                                          )
                                        ],
                                      );
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text("CÚ PHÁP TÌM KIẾM", style: TextStyle(fontSize: 20),),
                          ),
  ...
  String getQuery({required Map<String, String> params, required sortField, sort = "DESC", required page}) {
  ...
  String getSearchQuery({required Map<String, String> params, required String searchStr, required page}) {
...
class SortOption{
  ...
  SortOption({required this.index, required this.route, this.isSelected = false});
}