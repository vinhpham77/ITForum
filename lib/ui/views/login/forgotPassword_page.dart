...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
              ...
              children: <Widget>[
                ...
                const Padding(
                 ...
                 const Padding(
                  ...
                  child: Text("Gửi email của bạn. Chúng tôi sẽ gửi một liên kết đến email đó để bạn có thể đặt lại mật khẩu.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: Colors.black,
                          fontSize: 15)),
  ...
  bool isValid = await bloc.isValidInfo(_emailController.text);
